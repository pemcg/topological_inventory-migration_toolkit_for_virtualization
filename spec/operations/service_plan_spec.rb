require "topological_inventory/migration_toolkit_virtualization/operations/service_plan"

RSpec.describe TopologicalInventory::MigrationToolkitVirtualization::Operations::ServicePlan do
  context "#order" do
