  ...
  class Collector
    module ServiceCatalog
      def get_service_credentials(connection)
        ...
        TopologicalInventory::MigrationToolkitVirtualization::Iterator.new(fnc, "Couldn't fetch 'service_credentials' of service catalog.")
      end
      ...
      def get_service_credential_types(connection)
        ...
        TopologicalInventory::MigrationToolkitVirtualization::Iterator.new(fnc, "Couldn't fetch 'service_credential_type' of service catalog.")
      end
      ...
      def get_service_inventories(connection)
        ...
        TopologicalInventory::MigrationToolkitVirtualization::Iterator.new(fnc, "Couldn't fetch 'service_inventories' of service catalog.")
      end
      ...
      def get_service_offerings(connection)
        ...
        TopologicalInventory::MigrationToolkitVirtualization::Iterator.new(fnc, "Couldn't fetch 'service_offerings' of service catalog.")
      end
      ...
      def get_service_offering_nodes(connection)
        ...
        TopologicalInventory::MigrationToolkitVirtualization::Iterator.new(fnc, "Couldn't fetch 'service_offering_nodes' of service catalog.")
      end
      ...
      def get_service_instances(connection)
        ...
        TopologicalInventory::MigrationToolkitVirtualization::Iterator.new(fnc, "Couldn't fetch 'service_instances' of service catalog")
      end
      ...
      def get_service_instance_nodes(connection)
        ...
        TopologicalInventory::MigrationToolkitVirtualization::Iterator.new(fnc, "Couldn't fetch 'service_instance_nodes' of service catalog.")
      end

      # TODO: It seems that each request are sent twice in migration_toolkit_virtualization_client
