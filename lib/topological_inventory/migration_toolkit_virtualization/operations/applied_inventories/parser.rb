...
require "topological_inventory/migration_toolkit_virtualization/operations/applied_inventories/tree_item"
    ...
    module Operations
      module AppliedInventories
        ...
        class Parser
          ...
          #
          # @param tree_item [TopologicalInventory::MigrationToolkitVirtualization::Operations::AppliedInventories::TreeItem] tree node with Job Template
          ...
          #
          # @param tree_item [TopologicalInventory::MigrationToolkitVirtualization::Operations::AppliedInventories::TreeItem] tree node with Workflow Template
          ...
          # @param wf_template_tree_item [TopologicalInventory::MigrationToolkitVirtualization::Operations::AppliedInventories::TreeItem] tree item with Workflow Template
          ...
          # @param parent_wf_template_tree_item [TopologicalInventory::MigrationToolkitVirtualization::Operations::AppliedInventories::TreeItem] tree item with Workflow Template
